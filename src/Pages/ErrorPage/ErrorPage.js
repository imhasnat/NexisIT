            ...
            <div className="relative py-16 px-4 w-full min-h-screen bg-gray-50">
                <div className="flex flex-col items-center">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                        ...
                        <Link to='' className="px-5 py-2.5 rounded border-2 border-purple-400 bg-transparent text-center text-base text-purple-400 font-medium hover:border-purple-500 hover:text-purple-500">Contact Support</Link>
                    </div>


                    {/* :ILLUSTRATION */}
                    <img src="https://fancytailwind.com/static/under_construction-503cab99df4458de6d2801e7ee4fa400.svg" alt="" className="mt-10 max-w-xs" />
